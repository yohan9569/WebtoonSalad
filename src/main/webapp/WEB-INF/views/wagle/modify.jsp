...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/css/wagle/wagleModify.css">
</head>
<body>
	<!-- header -->
				...
				<div class="detailSection">
					<div class="wagleTitleSection">
						<label>제목</label> <input class="input" id="titleInput"
							name="title" value='<c:out value="${detailList.title}"/>'>
					</div>
					<div class="wagleFileSection">
						<label>파일</label> <input class="input" id="fileInput"
							name="content_file"
							value='<c:out value="${detailList.content_file}"/>'>
					</div>
					...
					<div class="buttonSection">
						...
						<button class="wagleButton" type="button">삭제</button>
						<button class="wagleButton" type="button"
							onclick="location.href='detail?id=<c:out value="${detailList.id}"/>'">확인</button>
					</div>
				</div>
			</div>
		</div>
